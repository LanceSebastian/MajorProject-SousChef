                        ...
                        for (j in 0..6) {
                            ...
                            Box(
                                modifier = Modifier
                                    ...
                                    .padding(4.dp)
                                    .background(
                                        color = if(dateSelected == date) dateColors[date] ?: colorScheme.primary else Color.Transparent,
                                        shape = CircleShape
                                    )
                                    .border(
                                        width = 1.dp,
                                ...
                                Text(
                                    ...
                                    color = if (dateSelected == date) colorScheme.onPrimary else if (today == date) colorScheme.primary else colorScheme.onSurface
                                )
                            }
                        }
                    }
